...
'''---**--- ParseExcel.py 用于实现读取Excel数据文件代码封装  ---**---'''
...
class ParseExcel(object):
    ...
    def __init__(self):
        self.workbook = None
        self.excelFile = None
        self.front = Font(color = None)    # 设置字体的颜色
    ...
    def getStarColNumber(self, sheet):
        '''获取sheet中有数据区域的开始列号'''
    ...
    def getCellOfValue(self, sheet, coordinate=None, rowNo=None, colsNo=None):
        ...
        if coordinate != None:
            try:
                # print("字典： %s" % sheet.cell["A2"].value)
...
if __name__ == '__main__':
    pe = ParseExcel()
    pe.loadWorkBook('D//PythonProject//126.xlsx')
